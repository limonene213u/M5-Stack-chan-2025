...
void setup() {
  ...
  M5.Display.print("Step 3: Avatar init...");
  avatar.init();
  ...
  M5.Display.print("Step 5: Battery...");
  if (M5.getBoard() != m5::board_t::board_M5Stack) {
    avatar.setBatteryIcon(true);
  }
  M5.Display.setCursor(10, 130);
  M5.Display.print("Step 6: Battery OK");
  
  M5.Display.setCursor(10, 150);
  M5.Display.print("Step 7: Speech test...");
  current_message = "システム初期化中...";
  avatar.setSpeechText(current_message.c_str());
  M5.Display.setCursor(10, 170);
  M5.Display.print("Step 8: Speech OK");
  delay(2000);
